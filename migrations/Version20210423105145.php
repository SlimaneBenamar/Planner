 ...
 */
final class Version20210423105145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__groupe AS SELECT id, nbr_etudiant, code_groupe FROM groupe');
        $this->addSql('DROP TABLE groupe');
        $this->addSql('CREATE TABLE groupe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nbr_etudiant INTEGER NOT NULL, code_groupe VARCHAR(100) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO groupe (id, nbr_etudiant, code_groupe) SELECT id, nbr_etudiant, code_groupe FROM __temp__groupe');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__groupe AS SELECT id, nbr_etudiant, code_groupe FROM groupe');
        $this->addSql('DROP TABLE groupe');
        $this->addSql('CREATE TABLE groupe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nbr_etudiant INTEGER NOT NULL, code_groupe VARCHAR(100) NOT NULL, seance_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO groupe (id, nbr_etudiant, code_groupe) SELECT id, nbr_etudiant, code_groupe FROM __temp__groupe');
        $this->addSql('DROP TABLE __temp__groupe');
