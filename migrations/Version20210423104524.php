 ...
 */
final class Version20210423104524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO groupe (id, seance_id, nbr_etudiant, code_groupe) SELECT id, seance_id, nbr_etudiant, code_groupe FROM __temp__groupe');
        $this->addSql('DROP TABLE __temp__groupe');
        $this->addSql('CREATE INDEX IDX_4B98C21E3797A94 ON groupe (seance_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__module AS SELECT id, lib_module FROM module');
        ...
        $this->addSql('INSERT INTO module (id, lib_module) SELECT id, lib_module FROM __temp__module');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__groupe AS SELECT id, seance_id, nbr_etudiant, code_groupe FROM groupe');
        $this->addSql('DROP TABLE groupe');
        $this->addSql('CREATE TABLE groupe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, seance_id INTEGER NOT NULL, nbr_etudiant INTEGER NOT NULL, code_groupe VARCHAR(100) NOT NULL)');
        $this->addSql('INSERT INTO groupe (id, seance_id, nbr_etudiant, code_groupe) SELECT id, seance_id, nbr_etudiant, code_groupe FROM __temp__groupe');
        $this->addSql('DROP TABLE __temp__groupe');
        $this->addSql('CREATE INDEX IDX_4B98C21E3797A94 ON groupe (seance_id)');
