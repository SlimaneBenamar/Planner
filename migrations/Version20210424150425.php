 ...
 */
final class Version20210424150425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_DF7DFD0E52EBEEF5 ON seance (date_debut)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_DF7DFD0E1C22B544 ON seance (date_fin)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__module');
        $this->addSql('CREATE INDEX IDX_C2426285200282E ON module (formation_id)');
        $this->addSql('DROP INDEX UNIQ_DF7DFD0E52EBEEF5');
        $this->addSql('DROP INDEX UNIQ_DF7DFD0E1C22B544');
        $this->addSql('DROP INDEX IDX_DF7DFD0E5A7D2DA5');
        $this->addSql('DROP INDEX IDX_DF7DFD0E71C15D5C');
        $this->addSql('DROP INDEX IDX_DF7DFD0E2FF709B6');
        $this->addSql('DROP INDEX IDX_DF7DFD0E7A45358C');
